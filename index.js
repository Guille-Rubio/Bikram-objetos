...
const FullStackDeveloper = {
    ...
    proyectos: ["Web Madrid", "Aplicacion A"]
};
...
const objeto = { nombreArchivo: 'doc1', copias: 2, numPaginas: 8 };
...
const Avion = { numPasajeros: 20, despegar: function () { console.log('despegando') }, volar: function () { console.log('llegando al destino') }, aterrizar: function () { console.log('aterrizando') } };

//16.- Crea un 'objeto' de nombre 'Paquete' que tenga la propiedad: 'array contenido con todos los objetos que contenga el paquete'

const Paquete = { contenido: ['arroz', 'azucar', 'pimientos'] };
